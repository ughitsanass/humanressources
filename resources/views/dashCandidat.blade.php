            ...
            <div class="bg-white border rounded shadow p-2">
                <div class="flex flex-row items-center">
                    ...
                    <div class="flex-1 text-right md:text-center">
                        ...
                        <h3 class="font-bold text-3xl"> {{$totalrevenue}}<span class="text-green-500"><i class="fas fa-caret-up"></i></span></h3>
                    </div>
                </div>
            </div>
            <!--/Metric Card-->
            ...
            <div class="bg-white border rounded shadow p-2">
                <div class="flex flex-row items-center">
                    ...
                    <div class="flex-1 text-right md:text-center">
                        ...
                        <h3 class="font-bold text-3xl"> {{$totalrevenue}}<span class="text-pink-500"><i class="fas fa-exchange-alt"></i></span></h3>
                    </div>
                </div>
            </div>
            <!--/Metric Card-->
